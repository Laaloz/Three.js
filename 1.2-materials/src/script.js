...
const doorAmbientOcclusionColorTexture = textureLoader.load(
...
const doorMetalnessColorTexture = textureLoader.load(
    "/textures/door/metalness.jpg"
);
const doorRoughnessColorTexture = textureLoader.load(
